...
Version  : 6.0.3
Release  : 112
URL      : https://download.kde.org/stable/plasma/6.0.3/plasma-integration-6.0.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.3/plasma-integration-6.0.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.3/plasma-integration-6.0.3.tar.xz.sig
...
%prep
%setup -q -n plasma-integration-6.0.3
cd %{_builddir}/plasma-integration-6.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711642492
mkdir -p clr-build
pushd clr-build
