...
Source0  : https://download.kde.org/stable/plasma/6.2.0/plasma-integration-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.0/plasma-integration-6.2.0.tar.xz.sig
...
%setup -q -n plasma-integration-6.2.0
cd %{_builddir}/plasma-integration-6.2.0
pushd ..
cp -a plasma-integration-6.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728613942
mkdir -p clr-build
pushd clr-build
