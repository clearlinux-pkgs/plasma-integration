...
%prep
%setup -q -n plasma-integration-5.17.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572442824
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/plasma-integration-5.17.2/COPYING.LGPL-3 %{buildroot}/usr/share/package-licenses/plasma-integration/f45ee1c765646813b442ca58de72e20a64a7ddba
pushd clr-build
%make_install
popd
