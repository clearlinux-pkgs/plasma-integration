...
Source0  : https://download.kde.org/stable/plasma/5.24.2/plasma-integration-5.24.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.24.2/plasma-integration-5.24.2.tar.xz.sig
...
%prep
%setup -q -n plasma-integration-5.24.2
cd %{_builddir}/plasma-integration-5.24.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645666147
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/plasma-integration-5.24.2/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/plasma-integration/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/plasma-integration-5.24.2/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/plasma-integration/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/plasma-integration-5.24.2/LICENSES/GPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/plasma-integration/2123756e0b1fc8243547235a33c0fcabfe3b9a51
cp %{_builddir}/plasma-integration-5.24.2/LICENSES/LGPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/plasma-integration/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/plasma-integration-5.24.2/LICENSES/LGPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/plasma-integration/a4c60b3fefda228cd7439d3565df043192fef137
cp %{_builddir}/plasma-integration-5.24.2/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/plasma-integration/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/plasma-integration-5.24.2/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/plasma-integration/19d98e1b6f8ef12849ea4012a052d3907f336c91
cp %{_builddir}/plasma-integration-5.24.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/plasma-integration/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/plasma-integration-5.24.2/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/plasma-integration/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
