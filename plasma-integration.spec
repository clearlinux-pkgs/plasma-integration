...
Version  : 5.16.4
Release  : 31
URL      : https://download.kde.org/stable/plasma/5.16.4/plasma-integration-5.16.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.16.4/plasma-integration-5.16.4.tar.xz
Source1 : https://download.kde.org/stable/plasma/5.16.4/plasma-integration-5.16.4.tar.xz.sig
...
%prep
%setup -q -n plasma-integration-5.16.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1564514160
mkdir -p clr-build
pushd clr-build
