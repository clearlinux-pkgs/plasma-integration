...
Version  : 6.2.5
Release  : 126
URL      : https://download.kde.org/stable/plasma/6.2.5/plasma-integration-6.2.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.2.5/plasma-integration-6.2.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.5/plasma-integration-6.2.5.tar.xz.sig
...
%setup -q -n plasma-integration-6.2.5
cd %{_builddir}/plasma-integration-6.2.5
pushd ..
cp -a plasma-integration-6.2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736183055
mkdir -p clr-build
pushd clr-build
