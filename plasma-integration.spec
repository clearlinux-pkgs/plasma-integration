...
Source0  : https://download.kde.org/stable/plasma/5.25.4/plasma-integration-5.25.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.25.4/plasma-integration-5.25.4.tar.xz.sig
...
%prep
%setup -q -n plasma-integration-5.25.4
cd %{_builddir}/plasma-integration-5.25.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659722425
mkdir -p clr-build
pushd clr-build
