...
Source0  : https://download.kde.org/stable/plasma/6.3.3/plasma-integration-6.3.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.3/plasma-integration-6.3.3.tar.xz.sig
...
%setup -q -n plasma-integration-6.3.3
cd %{_builddir}/plasma-integration-6.3.3
pushd ..
cp -a plasma-integration-6.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742483043
mkdir -p clr-build
pushd clr-build
