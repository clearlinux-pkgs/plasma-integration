...
Version  : 5.27.3
Release  : 98
URL      : https://download.kde.org/stable/plasma/5.27.3/plasma-integration-5.27.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.3/plasma-integration-5.27.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.3/plasma-integration-5.27.3.tar.xz.sig
...
%prep
%setup -q -n plasma-integration-5.27.3
cd %{_builddir}/plasma-integration-5.27.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679516594
mkdir -p clr-build
pushd clr-build
