...
Version  : 5.27.9
Release  : 105
URL      : https://download.kde.org/stable/plasma/5.27.9/plasma-integration-5.27.9.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.9/plasma-integration-5.27.9.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.9/plasma-integration-5.27.9.tar.xz.sig
...
%prep
%setup -q -n plasma-integration-5.27.9
cd %{_builddir}/plasma-integration-5.27.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698282911
mkdir -p clr-build
pushd clr-build
