...
Version  : 5.15.5
Release  : 23
URL      : https://download.kde.org/stable/plasma/5.15.5/plasma-integration-5.15.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.15.5/plasma-integration-5.15.5.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.15.5/plasma-integration-5.15.5.tar.xz.sig
...
%prep
%setup -q -n plasma-integration-5.15.5
...
export LANG=C
export SOURCE_DATE_EPOCH=1557246771
mkdir -p clr-build
pushd clr-build
export AR=gcc-ar
