...
Source0  : https://download.kde.org/stable/plasma/5.14.3/plasma-integration-5.14.3.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.3/plasma-integration-5.14.3.tar.xz.sig
...
%prep
%setup -q -n plasma-integration-5.14.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1541534984
mkdir -p clr-build
pushd clr-build
%cmake ..
