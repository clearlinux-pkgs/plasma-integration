...
Version  : 6.0.5
Release  : 114
URL      : https://download.kde.org/stable/plasma/6.0.5/plasma-integration-6.0.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.0.5/plasma-integration-6.0.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.5/plasma-integration-6.0.5.tar.xz.sig
...
%setup -q -n plasma-integration-6.0.5
cd %{_builddir}/plasma-integration-6.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716390946
mkdir -p clr-build
pushd clr-build
